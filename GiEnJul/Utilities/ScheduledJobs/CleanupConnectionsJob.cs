...
public class CleanupConnectionsJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        var recipientIds = staleGivers.Where(g => !string.IsNullOrWhiteSpace(g.MatchedRecipient)).Select(g => g.MatchedRecipient!);
    ...
    {
        var connectedRecipientIds = giversToNotify.Where(g => !string.IsNullOrWhiteSpace(g.MatchedRecipient)).Select(g => g.MatchedRecipient!);
