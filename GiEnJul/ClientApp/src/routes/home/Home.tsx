...
const Home = () => (
  <div>
    ...
    <Button onClick={() => { history.push('/registerGiver/LocationGiver') }}>Bli Giver
    </Button>)}/>
    </p>
      <div>
        <p><Button>
      ...
      <Questions/>
      <Companies/>
      <Tab maxPagePosition= {140} textField="Bli giver" styling ='button-giver' path='/registerGiver/LocationGiver'/>
