...
public class AdminController : ControllerBase
{
    ...
    public async Task<FileStreamResult> DownloadExcelDeliveryLocationAsync(string location)
    {
        ...
        if (eventName == null)
        {
            throw new Exception($"No active event for location {location}");
        }
    ...
    public async Task<ActionResult> DeleteRecipientAsync([FromBody] DeleteRecipientDto recipientDto)
    {
        ...
        if (recipientToDelete.IsSuggestedMatch && !string.IsNullOrWhiteSpace(recipientToDelete.MatchedGiver))
        {
    ...
    public async Task<ActionResult> DeleteGiverAsync([FromBody] DeleteGiverDto giverDto)
    {
        ...
        if (giver.IsSuggestedMatch && !string.IsNullOrWhiteSpace(giver.MatchedRecipient))
        {
    ...
    public async Task<FileStreamResult> GetPersonsByEvent(string municipality)
    {
        ...
        if (eventName == null)
        {
            throw new Exception($"no active event for location {municipality}");
        }
