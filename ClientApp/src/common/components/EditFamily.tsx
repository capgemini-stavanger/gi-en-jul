                ...
                <Table size="small" aria-label="purchases">
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        <Input type="text" value={newRecipient.referenceId} onChange={(e: React.ChangeEvent<HTMLInputElement>) => {newRecipient.referenceId = e.target.value; setNewRecipient((prev) => {return { ...prev, referenceId: e.target.value }})}}/>         </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                <Typography variant="h6" gutterBottom component="div">
                  ...
                  <TableBody>
                    {newRecipient.familyMembers.map((familyMember : PersonType , index: number) => (
                      <TableRow key={familyMember.rowKey}>
                        ...
                        <TableCell component="th" scope="row">
                          <Input type="text" value={familyMember.wish} onChange={(e: React.ChangeEvent<HTMLInputElement>) => {familyMember.wish=e.target.value; setNewRecipient((prev) => { return { ...prev, age:(e.target.value) }})}}/>
                        </TableCell>
                        <TableCell component="th" scope="row">
                          <Input type="text" value={familyMember.comment} onChange={(e: React.ChangeEvent<HTMLInputElement>) => {familyMember.comment=e.target.value; setNewRecipient((prev) => { return{ ...prev, age:(e.target.value) }})}}/>
                        </TableCell>
                        { !familyMember.rowKey &&
                          <TableCell>
                          <IconButton
