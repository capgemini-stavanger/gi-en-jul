...
const Information: React.FC = () => {
        ...
        <Card className={classes.contactCard}>
          ...
          <CardActions className={classes.contactContent}>
            <IconButton>
              ...
              <a href="mailto:e.ohlgren@gmail.com">
                <Typography color="primary">e.ohlgren@gmail.com</Typography>
              </a>
            </IconButton>
          </CardActions>
        </Card>
  ...
  return (
    <Container id="information" className={classes.sectionContainer}>
      <div className={classes.headLineContainer}></div>
